...
Foam::viscosityModels::HerschelBulkleyPapanastasiou::calcNu() const
{
    ...
    (
        ...
        (
            nu0_,
            (tau0_*(1.0-Foam::exp(-(m_*sr())/sr0_)) + k_*rtone*pow(tone*sr(), n_))
...
:
    ...
    k_("k", dimViscosity, HerschelBulkleyPapanastasiouCoeffs_),
    n_("n", dimless, HerschelBulkleyPapanastasiouCoeffs_),
    tau0_("tau0", dimViscosity/dimTime, HerschelBulkleyPapanastasiouCoeffs_),
    nu0_("nu0", dimViscosity, HerschelBulkleyPapanastasiouCoeffs_),
    m_("m", dimless, HerschelBulkleyPapanastasiouCoeffs_),
	sr0_("sr0", dimless/dimTime, HerschelBulkleyPapanastasiouCoeffs_),
    nu_
    (
        IOobject
        (
...
)
{
    ...
    HerschelBulkleyPapanastasiouCoeffs_.lookup("sr0") >> sr0_;
